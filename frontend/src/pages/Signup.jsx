          ...
          <div className="flex items-center gap-3">
            <div className="flex justify-start">
              <img
                src={Logo}
                alt="ClientRunway"
                className="h-23 w-auto object-contain -ml-14"
              />
            </div>
          ...
          <div className="rounded-2xl border border-slate-200/80 bg-white p-8 shadow-sm lg:p-10">
            <div className="mb-8">
              ...
              <p className="mt-2 text-sm leading-relaxed text-slate-500">
                Get started with ClientRunway and start tracking onboarding today
              </p>
            </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      autoComplete="new-password"
                      disabled={loading}
                      className={`${inputClassName("confirmPassword")} pr-16`}
                    />
                    <button
                      type="button"
                      onClick={() =>
